...
import { getChapters } from './services/libraryService';
...
const App: React.FC = () => {
  ...
  const handleBookSelect = async (book: Book) => {
    ...
    setCurrentChapterId(null); // Reset chapter when selecting a new book
    
    // Fetch the first chapter of the book
    try {
          ...
          <div className="flex-1 h-full relative">
            {currentBook ? (
              <Reader 
                ...
                currentChapterId={currentChapterId} // Pass current chapter ID
              />
            ) : (
              <WelcomeExperience 
                settings={settings} 
